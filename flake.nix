{
  ...
  outputs = {
    ...
    settings = {
      # User configuration
      username = "birb"; # automatically set with install.sh and live-install.sh
      editor = "vscode"; # nixvim, vscode, helix, nvchad, neovim, emacs (WIP)
      ...
      hostname = "BirbNix"; # CHOOSE A HOSTNAME HERE
      ...
      consoleKeymap = ""; # CHOOSE YOUR CONSOLE KEYMAP (Affects the tty?)
    };
